...
public interface ProductService {
	...
	void addProduct(String productName, int prodCategory, Long price, String prodSize, Long salesQuantity,
	...
	Page<Product> searchProductsByName(String search, Pageable pageable);
}
